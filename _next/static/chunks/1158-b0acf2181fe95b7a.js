    ...
    4345: (e, t, r) => {
      ...
      function c(e) {
        ...
        return (0, a.jsxs)(a.Fragment, {
          children: [
            (0, a.jsx)("div", { id: r }),
            (0, a.jsx)("div", { className: "mt-16", children: t }),
          ],
        });
      }
      let x = (e) => {
        ...
        return (0, a.jsx)("div", {
          ...
          children: (0, a.jsx)("span", {
            className:
              "rounded-xl border px-2 py-1 text-m font-medium text-fd-muted-foreground dark:border-zinc-700",
            children: t,
          }),
        });
      };
      function g(e) {
        let { faqData: t } = e,
          [r, g] = (0, s.useState)(null),
          [u, m] = (0, s.useState)(new Set()),
          h = (e) => {
            m((t) => {
              let r = new Set(t);
                  ...
                  "div",
                  {
                    ...
                    children: [
                      (0, a.jsx)("button", {
                        onClick: () => h(e.id),
                        className:
                          "cursor-pointer w-full text-left p-6 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors duration-200",
                        children: (0, a.jsxs)("h3", {
                          className:
                            "text-xl font-semibold flex items-center justify-between text-gray-900 dark:text-gray-100",
                          id: e.id,
                          children: [
                            (0, a.jsxs)("span", {
                              ...
                              children: [
                                ...
                                (0, a.jsx)("button", {
                                  ...
                                  className:
                                    "hover:bg-gray-100 dark:hover:bg-gray-800 active:scale-95 transition-all duration-200 rounded-md p-1 -m-1 ".concat(
                                      r === e.id
                      ...
                      t &&
                        (0, a.jsx)("div", {
                          className:
                            "px-6 pb-6 text-lg leading-relaxed text-gray-700 dark:text-gray-300 prose prose-lg dark:prose-invert max-w-5xl",
                          children: (0, a.jsx)(l.oz, { children: e.answer }),
                        }),
                    ],
                  },
                  e.id
    ...
    8942: (e, t, r) => {
      ...
      function g(e) {
        ...
        return (0, a.jsx)("div", {
          ...
          className: l("leading-none font-semibold", t),
          ...r,
        });
      }
      function u(e) {
      ...
      function h(e) {
        ...
        return (0, a.jsx)("div", {
          ...
          className: l("flex items-center px-6 [.border-t]:pt-6", t),
          ...r,
        });
      }
      var p = r(9649);
      ...
      function f(e) {
        ...
        return (0, a.jsx)(d, {
          "data-slot": "button",
          className: l(b({ variant: r, size: s, className: t })),
          ...i,
        });
      }
      var v = r(8864),
        ...
        P = r(2942),
        R = r(2935);
      let E = (0, R.createServerReference)(
      ...
      let I = [
          {
            ...
            features: [
              ...
              { text: "Downloadable for macOS & Windows", icon: y.A },
              { text: "No sign-up required", icon: k.A },
              { text: "Bring your own API key", icon: j.A },
              { text: "Community support", icon: w.A },
            ],
            ctaText: "Get Started",
          ...
          },
          {
            ...
            features: [
              { text: "Everything in Denjin Free plus...", icon: N.A },
              { text: "Exclusive AI Pro modes", icon: A.A },
              { text: "300 AI credits/month", icon: S.A },
              { text: "Direct support & influence product roadmap", icon: z.A },
              { text: "Full Denjin Academy access", icon: C.A },
            ],
          ...
          },
          {
            ...
            features: [
              { text: "Everything in Denjin Pro plus...", icon: N.A },
              {
                text: "900 AI credits/month (3x more, 12% savings compared to Pro)",
                icon: F.A,
              },
              { text: "Reload credits at any time (same price)", icon: D.A },
            ],
